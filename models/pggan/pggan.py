...
class PGGAN(object):
    ...
    def build_model(self):
        ...
        self.Dx_hat_logit, self.Dxma_hat_logit = self.discriminator(self.x_hat, self.cond, reuse=True, stages=self.stage, t=self.trans)
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            for idx in range(start_point + 1, self.max_iters):
                ...
                if np.mod(idx, 2500) == 0 or idx == self.max_iters - 1:
